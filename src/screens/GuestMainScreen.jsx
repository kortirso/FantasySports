      ...
      >
        <View>
          ...
          <View style={styles.loginBox}>
            <Button title="Login" onPress={() => setPageState({ ...pageState, modalForLogin: true })} />
            <Button title="Sign up" onPress={() => setPageState({ ...pageState, modalForSignup: true })} />
          </View>
        </View>
        <Popup
          visible={pageState.modalForLogin}
          onRequestClose={() => setPageState({ ...pageState, modalForLogin: false, errors: [] })}
          title="Login"
        >
        ...
        <Popup
          ...
          onRequestClose={() => setPageState({ ...pageState, modalForSignup: false, errors: [] })}
          title="Signup"
        >
          <View style={{ flexDirection: 'column', gap: 16 }}>
            <FormField
