...
const fetchAllGames = async (weekId, accessToken) => {
  try {
    ...
    const response = await fetch(`${API_HOST}/api/v1/games?week_id=${weekId}&response_include_fields=${responseIncludeFields}&api_access_token=${accessToken}&sort_by=start_at&sort_direction=asc`, {
      method: "GET"
    });
