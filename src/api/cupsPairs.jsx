...
const fetchAllCupsPairs = async (cupsRoundId, accessToken) => {
  try {
    ...
    const response = await fetch(`${API_HOST}/api/v1/cups/pairs?cups_round_id=${cupsRoundId}&response_include_fields=${responseIncludeFields}&api_access_token=${accessToken}&sort_by=start_at&sort_direction=asc`, {
      method: "GET"
    });
